...
-- ix) TIMESTAMPDIFF(unit, start_date, end_date) → returns the difference in the specified unit (YEAR, MONTH, DAY, etc.).
select timestampdiff(month,'2025-10-17',curdate()) as month_diff;
